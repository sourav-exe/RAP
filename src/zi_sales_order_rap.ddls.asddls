...
define root view entity ZI_SALES_ORDER_RAP
  ...
  association [0..1] to ZI_SO_TEXT_VH  as _SalesDocTypeText on  _SalesDocTypeText.SalesDocType = $projection.DocumentType
  ...
  composition [0..*] of ZI_SO_ITEM_RAP as _SalesOrderItem
{
  key vbeln                                   as SalesOrder,
      ...
      _SalesDocTypeText.SalesDocTypeText as DocumentTypeText,
